...
def _on_page(canvas, doc):
    ...
    canvas.drawString(1.4*cm, 0.6*cm, "PCI DSS v4.0 for NBFC  |  Companion Playbook  |  Fresher to Expert  |  Landscape A4")
...
t = Table(LEVELS, colWidths=[2.1*cm, 11.76*cm, 10.92*cm])
...
t = Table(TWELVE, colWidths=[1.68*cm, 23.1*cm])
t.setStyle(TableStyle([
    ("BACKGROUND", (0,0), (-1,0), PRIMARY),
    ("TEXTCOLOR",  (0,0), (-1,0), white),
    ("FONTNAME",   (0,0), (-1,0), "Helvetica-Bold"),
...
t = Table(DA_CA, colWidths=[3.92*cm, 9.8*cm, 11.06*cm])
t.setStyle(TableStyle([
    ("BACKGROUND", (0,0), (-1,0), PRIMARY),
    ("TEXTCOLOR",  (0,0), (-1,0), white),
    ("FONTNAME",   (0,0), (-1,0), "Helvetica-Bold"),
...
t = Table(PILLARS_REG, colWidths=[6.44*cm, 5.6*cm, 12.74*cm])
t.setStyle(TableStyle([
    ("BACKGROUND", (0,0), (-1,0), PRIMARY),
    ("TEXTCOLOR",  (0,0), (-1,0), white),
    ("FONTNAME",   (0,0), (-1,0), "Helvetica-Bold"),
...
t = Table(ROADMAP, colWidths=[3.64*cm, 1.96*cm, 19.18*cm])
t.setStyle(TableStyle([
    ("BACKGROUND", (0,0), (-1,0), PRIMARY),
    ("TEXTCOLOR",  (0,0), (-1,0), white),
    ("FONTNAME",   (0,0), (-1,0), "Helvetica-Bold"),
...
t = Table(PILLARS_DISC, colWidths=[7.42*cm, 8.54*cm, 8.82*cm])
t.setStyle(TableStyle([
    ("BACKGROUND", (0,0), (-1,0), PRIMARY),
    ("TEXTCOLOR",  (0,0), (-1,0), white),
    ("FONTNAME",   (0,0), (-1,0), "Helvetica-Bold"),
...
t = Table(CDFD, colWidths=[8.68*cm, 16.1*cm])
t.setStyle(TableStyle([
    ("BACKGROUND", (0,0), (-1,0), PRIMARY),
    ("TEXTCOLOR",  (0,0), (-1,0), white),
    ("FONTNAME",   (0,0), (-1,0), "Helvetica-Bold"),
...
t = Table(TRA_TEMPLATE, colWidths=[6.16*cm, 18.62*cm])
t.setStyle(TableStyle([
    ("BACKGROUND", (0,0), (-1,0), PRIMARY),
    ("TEXTCOLOR",  (0,0), (-1,0), white),
    ("FONTNAME",   (0,0), (-1,0), "Helvetica-Bold"),
...
t = Table(SCOPE, colWidths=[8.68*cm, 16.1*cm])
t.setStyle(TableStyle([
    ("BACKGROUND", (0,0), (-1,0), PRIMARY),
    ("TEXTCOLOR",  (0,0), (-1,0), white),
    ("FONTNAME",   (0,0), (-1,0), "Helvetica-Bold"),
...
t = Table(MASTER, colWidths=[0.98*cm, 17.78*cm, 6.02*cm])
t.setStyle(TableStyle([
    ("BACKGROUND", (0,0), (-1,0), PRIMARY),
    ("TEXTCOLOR",  (0,0), (-1,0), white),
    ("FONTNAME",   (0,0), (-1,0), "Helvetica-Bold"),
...
t = Table(CDE, colWidths=[2.38*cm, 5.88*cm, 1.96*cm, 5.04*cm, 3.08*cm, 1.96*cm, 4.48*cm])
t.setStyle(TableStyle([
    ("BACKGROUND", (0,0), (-1,0), PRIMARY),
    ("TEXTCOLOR",  (0,0), (-1,0), white),
    ("FONTNAME",   (0,0), (-1,0), "Helvetica-Bold"),
...
t = Table(SP, colWidths=[1.82*cm, 4.76*cm, 4.9*cm, 4.48*cm, 1.96*cm, 3.08*cm, 3.78*cm])
t.setStyle(TableStyle([
    ("BACKGROUND", (0,0), (-1,0), PRIMARY),
    ("TEXTCOLOR",  (0,0), (-1,0), white),
    ("FONTNAME",   (0,0), (-1,0), "Helvetica-Bold"),
...
t = Table(CRYPTO, colWidths=[4.9*cm, 5.6*cm, 1.96*cm, 4.48*cm, 3.36*cm, 4.48*cm])
t.setStyle(TableStyle([
    ("BACKGROUND", (0,0), (-1,0), PRIMARY),
    ("TEXTCOLOR",  (0,0), (-1,0), white),
    ("FONTNAME",   (0,0), (-1,0), "Helvetica-Bold"),
...
t = Table(ASV, colWidths=[2.8*cm, 3.5*cm, 5.6*cm, 5.04*cm, 3.36*cm, 4.48*cm])
t.setStyle(TableStyle([
    ("BACKGROUND", (0,0), (-1,0), PRIMARY),
    ("TEXTCOLOR",  (0,0), (-1,0), white),
    ("FONTNAME",   (0,0), (-1,0), "Helvetica-Bold"),
...
t = Table(PT, colWidths=[11.9*cm, 7.56*cm, 5.32*cm])
t.setStyle(TableStyle([
    ("BACKGROUND", (0,0), (-1,0), PRIMARY),
    ("TEXTCOLOR",  (0,0), (-1,0), white),
    ("FONTNAME",   (0,0), (-1,0), "Helvetica-Bold"),
...
t = Table(ROC, colWidths=[9.1*cm, 15.68*cm])
t.setStyle(TableStyle([
    ("BACKGROUND", (0,0), (-1,0), PRIMARY),
    ("TEXTCOLOR",  (0,0), (-1,0), white),
    ("FONTNAME",   (0,0), (-1,0), "Helvetica-Bold"),
...
t = Table(NS, colWidths=[2.24*cm, 12.18*cm, 10.36*cm])
t.setStyle(TableStyle([
    ("BACKGROUND", (0,0), (-1,0), PRIMARY),
    ("TEXTCOLOR",  (0,0), (-1,0), white),
    ("FONTNAME",   (0,0), (-1,0), "Helvetica-Bold"),
...
t = Table(DATA_INV, colWidths=[5.6*cm, 6.58*cm, 5.6*cm, 6.86*cm])
t.setStyle(TableStyle([
    ("BACKGROUND", (0,0), (-1,0), PRIMARY),
    ("TEXTCOLOR",  (0,0), (-1,0), white),
    ("FONTNAME",   (0,0), (-1,0), "Helvetica-Bold"),
...
t = Table(FINDS, colWidths=[1.4*cm, 20.16*cm, 3.22*cm])
t.setStyle(TableStyle([
    ("BACKGROUND", (0,0), (-1,0), PRIMARY),
    ("TEXTCOLOR",  (0,0), (-1,0), white),
    ("FONTNAME",   (0,0), (-1,0), "Helvetica-Bold"),
...
t = Table(RDY + [["Area", "% Complete"]][1:], colWidths=[16.8*cm, 7.98*cm])
t.setStyle(TableStyle([
    ("BACKGROUND", (0,0), (-1,0), PRIMARY),
    ("TEXTCOLOR",  (0,0), (-1,0), white),
    ("FONTNAME",   (0,0), (-1,0), "Helvetica-Bold"),
...
t = Table(g_table, colWidths=[5.04*cm, 19.74*cm])
t.setStyle(TableStyle([
    ("BACKGROUND", (0,0), (-1,0), PRIMARY),
    ("TEXTCOLOR",  (0,0), (-1,0), white),
    ("FONTNAME",   (0,0), (-1,0), "Helvetica-Bold"),
